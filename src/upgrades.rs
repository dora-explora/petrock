...
pub fn upgrades() -> [Upgrade; NUMUPGRADES] {[
    ...
    Upgrade::new(false, '⌁', Color::Green, "Better-Petter-o-matic", "the companies merged",      15000, 5000, 200),
    Upgrade::new(false, '!', Color::LightRed, "Petter Overclock", "1000 Hz auto-petter",         100000, 50000, 1000),
    Upgrade::new(true, '💪', Color::Yellow, "Gym Sesh", "No pain, no gain",                      250000, 200000, 250),
    ...
    Upgrade::new(false, '⌨', Color::Magenta, "Petting Machine", "nvm",                          10000000, 5000000, 50000),
]}
